    ...
    <header className="h-14 w-full bg-[#07162E] border-b border-slate-700 flex items-center justify-between px-4 sm:px-5 relative z-40">
      ...
      <div className="flex items-center gap-3 min-w-0">
        ...
        <div className="leading-4 min-w-0">
          ...
          <p className="hidden max-w-52 truncate text-[10px] text-slate-400 sm:block">
            {user?.organization_name || (role === "Super Admin" ? "System Administration" : "Organization Workspace")}
          </p>
        </div>
